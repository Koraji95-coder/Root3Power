...
namespace R3P.Conduit.Services
{
    ...
    internal static class TemplateService
    {
        ...
        {
            public string Number;      // e.g., R3P-1001
            public string Title;       // e.g., One-Line Diagram
            public string TemplatePath; // border/template dwg
            public Dictionary<string, string> TitleBlockAttributes; // tag->value
        }
