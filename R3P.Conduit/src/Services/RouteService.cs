...
namespace R3P.Conduit.Services
{
    internal static class RouteService
    {
        ...
        public static List<Point3d> SmartRoute(Database db, Point3d p1, Point3d p2)
        {
            ...
            var open = new SortedSet<(double f, int n)>(Comparer<(double, int)>.Create((a, b) => a.f == b.f ? a.n.CompareTo(b.n) : a.f.CompareTo(b.f)));
            ...
            g[sKey] = 0.0; open.Add((h(sKey), sKey));
            int[] dx4 = { 1, -1, 0, 0 };
            int[] dy4 = { 0, 0, 1, -1 };
