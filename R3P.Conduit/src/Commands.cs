...
using R3P.Conduit.UI.Wpf;

namespace R3P.Conduit
{
    ...
    public static class R3P
    {
        ...
        internal static void UiExportCsv()
        {
            ...
            var dlg = new SaveFileDialog { Filter = "CSV Files (*.csv)|*.csv", FileName = "conduit_items.csv" };
        ...
        internal static void UiPlaceTagForSelected(Model.ConduitItem selected)
        {
            ...
            var doc = Application.DocumentManager.MdiActiveDocument; var ed = doc.Editor; var db = doc.Database;
        ...
        {
            var doc = Application.DocumentManager.MdiActiveDocument; if (doc == null) return new List<Model.ConduitItem>();
